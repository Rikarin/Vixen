...
public class GraphDocumentTests {
    ...
    /// <remarks>
    ///     ⚠ <b>Through
    ///     <see cref="SubGraphs.Flatten(NodeGraphModel, ISubGraphSource, out IReadOnlyList{NodeDiagnostic}, out NodeGraphInlining)" />
    ///     rather than through the copy</b>, because the
