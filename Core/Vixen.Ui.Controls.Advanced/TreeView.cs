...
///     </para>
///     <para>
///         <b>A resize no longer needs telling.</b> The panel realises on
///         <see cref="UiDocument.LayoutFinished" />, so a tree whose box changed without being
///         scrolled is right on the next pass — which is what <see cref="Refresh" /> used to be
///         called for and is not any more.
///     </para>
/// </remarks>
