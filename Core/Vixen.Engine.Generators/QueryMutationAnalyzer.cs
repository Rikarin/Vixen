...
///         rule people turn off wholesale. <c>#pragma warning disable VXS0414</c> with a line saying
...
public sealed class QueryMutationAnalyzer : DiagnosticAnalyzer {
    ...
    public const string DiagnosticId = "VXS0414";
    ...
    static readonly DiagnosticDescriptor Rule = new(
        ...
        + "this; #pragma warning disable VXS0414 with a reason is the way to say you meant it."
    );
