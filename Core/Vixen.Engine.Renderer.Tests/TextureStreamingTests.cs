...
public sealed class TextureStreamingTests {
    ...
    ///         that is why the give-up here is progress rather than
    ///         <see cref="Settling.Until(System.Action, System.Func{bool}, System.Func{Settling.Work}, string)" />'s
    ...
    ///     <see cref="Settling.Until(System.Action, System.Func{bool}, System.Func{Settling.Work}, string)" />
    ///     are all asking the same question about the same streamer.
    /// </remarks>
