...
public class ReducedMotionTests {
    ...
    public void The_feature_answers_reduce_when_the_context_says_so() {
        var reduced = new MediaContext(800f, 600f, Preferences: new MediaPreferences(MotionPreference.Reduce));
    ...
    public void The_boolean_form_means_reduce() {
        Assert.True(
            MediaQuery.TryEvaluate(
                ...
                new MediaContext(800f, 600f, Preferences: new MediaPreferences(MotionPreference.Reduce)),
                out var reduced,
                out _
            )
        );
    ...
    public void A_reduced_motion_block_wins_when_the_preference_is_set() {
        ...
        fixture.Load(
            ...
            """,
            media: new MediaContext(800f, 600f, Preferences: new MediaPreferences(MotionPreference.Reduce))
        );
    ...
    public void The_engine_hands_the_preference_to_its_animator_and_keeps_it_across_a_reload() {
        ...
        engine.SetMedia(new MediaContext(800f, 600f, Preferences: new MediaPreferences(MotionPreference.Reduce)));
