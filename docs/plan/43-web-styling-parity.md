...
| Utility **roots** (the unit of this table) | **331** | 314 families |
...
| State | Meaning | Roots |
|---|--:|--:|
| **works** | Vixen emits it, and a consumer acts on every property it sets | **251** |
