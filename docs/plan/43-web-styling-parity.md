...
| Utility **roots** (the unit of this table) | **331** | 318 families |
...
| State | Meaning | Roots |
|---|--:|--:|
| **works** | Vixen emits it, and a consumer acts on every property it sets | **255** |
...
**Size: 0.2 EM remaining**, from 0.4. The variants and the marker family landed; the coercion and the
