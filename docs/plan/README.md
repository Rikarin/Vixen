...
| 30 | [Post-processing Parity](30-post-processing-parity.md) | ⚠️ Extends 06 — the audit behind doc 06's post-process lines: every effect Unreal 5.8 and Unity HDRP 14 ship, what Vixen has against each, and which we adopt |
