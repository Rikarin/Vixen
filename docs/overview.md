...
| 47 | `Vixen.Ui.Controls.Advanced` | Undo (`CodeBuffer` states outright that it has no stack); `CodeEditor` caret blink (wrap landed 2026-09-02); `AppendChild` O(n)… | [#184](https://github.com/Rikarin/Vixen/issues/184) |
