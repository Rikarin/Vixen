...
since: 0.1
status: preview
related: [ui/commands, ui/dialogs, ui/strings, ui/background-tasks, editor/modes, editor/play-mode-systems, editor/external-edits, editor/scene-menus, editor/icons, editor/utility-styles, editor/editing-pipeline, editor/writing-a-plugin, editor/editor-scripts, editor/inspectors-in-markup, editor/frame-panel, editor/network-panel, editor/sub-object-picking, editor/selection-cage, editor/snapping, editor/precision, editor/mesh-editing, editor/element-selection, editor/shape-tool, editor/face-materials, editor/booleans, editor/retopology-and-uv-surfaces, editor/vfx-graph, editor/shader-graph-previews, editor/graph-diagnostics]
---
