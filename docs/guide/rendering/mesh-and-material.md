...
| `MetalRoughnessSurface`, `TexturedMetalRoughnessSurface`, `SpecularGlossinessSurface`, `NormalMapSurface`, `EmissiveSurface`, `OcclusionSurface` | same | The base and always-available features |
