...
| `MetalRoughnessSurface`, `TexturedMetalRoughnessSurface`, `SpecularGlossinessSurface`, `NormalMapSurface`, `TexturedNormalMapSurface`, `EmissiveSurface`, `OcclusionSurface` | same | The base and always-available features |
