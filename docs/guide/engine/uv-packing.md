...
since: 0.1
status: preview
related: [engine/uv-charting, engine/uv-flattening, engine/uv-texel-density, engine/uv-stacking, engine/map-baking, engine/edit-meshes, engine/mesh-operations]
---
