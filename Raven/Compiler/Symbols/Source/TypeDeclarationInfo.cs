...
public sealed class TypeDeclarationInfo {
    ...
    public static TypeDeclarationInfo? From(MemberDeclarationSyntax syntax) => syntax switch {
        ShaderDeclarationSyntax s => new TypeDeclarationInfo(
            s, s.AttributeLists, s.Modifiers, s.Identifier, s.TypeParameterList, s.BaseList,
            s.ConstraintClauses, Materialize(s.Members), TypeKind.Shader),
        StructDeclarationSyntax s => new TypeDeclarationInfo(
            s, s.AttributeLists, s.Modifiers, s.Identifier, s.TypeParameterList, s.BaseList,
            s.ConstraintClauses, Materialize(s.Members), TypeKind.Struct),
        ClassDeclarationSyntax s => new TypeDeclarationInfo(
            s, s.AttributeLists, s.Modifiers, s.Identifier, s.TypeParameterList, s.BaseList,
            s.ConstraintClauses, Materialize(s.Members), TypeKind.Class),
        ProtocolDeclarationSyntax s => new TypeDeclarationInfo(
            s, s.AttributeLists, s.Modifiers, s.Identifier, s.TypeParameterList, s.BaseList,
            s.ConstraintClauses, Materialize(s.Members), TypeKind.Protocol),
        EnumDeclarationSyntax s => new TypeDeclarationInfo(
            s, s.AttributeLists, s.Modifiers, s.Identifier, null, s.BaseList,
            default, s.Members.Cast<MemberDeclarationSyntax>().ToArray(), TypeKind.Enum),
        _ => null
    };
